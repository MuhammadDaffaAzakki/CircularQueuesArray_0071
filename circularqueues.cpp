 ...
 * 
 * @section Operations
 * Project ini memiliki project struktur data
 ...
 * @date 2025-06-24
 * 
 * @copyright daffa.azakki.ft24@mail.umy.ac.id (c) 2025
 * 
 */
...
public:
    ...
    void insert()
    {
        ...
        {
            // jika rear kembali berada di posisi terakhir array, kembali ke awal array
            if (REAR == max - 1)
                REAR = 0;
            else    
                REAR = REAR + 1;
    ...
    /** 
     * @brief method untuk menampilkan data daklam antrian
